...
interface OfferUpdatedIconProps {
  width?: number;
  height?: number;
  color?: string;
}

export default function OfferUpdatedIcon({
  width = 18,
  height = 18,
  color = '#393939',
}: OfferUpdatedIconProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 122.88 121.51" fill="none">
      <Path
        fill={color}
