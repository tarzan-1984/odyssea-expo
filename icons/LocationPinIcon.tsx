...
/**
 * Custom location pin icon: red teardrop with dark blue outline and light pink center
 */
export default function LocationPinIcon({
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 92.25 122.88">
      {/* Red teardrop pin shape with dark blue outline */}
      <Path
        ...
        fillRule="evenodd"
      />
      {/* Light pink/beige center circle with dark blue outline */}
      <Circle
        cx="46.13"
        cy="46.76"
        r="12"
