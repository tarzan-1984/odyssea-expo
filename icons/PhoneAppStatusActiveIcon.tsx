...
interface PhoneAppStatusActiveIconProps {
  width?: number;
  height?: number;
}

/**
 * Phone icon with green check - driver uses the app (ACTIVE status).
 * Matches Next.js OffersList active driver icon.
 */
export default function PhoneAppStatusActiveIcon({
  width = 20,
  height = 26,
}: PhoneAppStatusActiveIconProps) {
  return (
    <Svg
      width={width}
      height={height}
